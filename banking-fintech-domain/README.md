...
> Nghiệp vụ ngân hàng không khó vì thuật toán — nó khó vì **không được phép sai**.
...
| Tài liệu | Nội dung |
|---|---|
| [00-gioi-thieu.md](00-gioi-thieu.md) | Khoá học: Nghiệp vụ Ngân hàng & Fintech |
| [00-thuat-ngu.md](00-thuat-ngu.md) | Từ điển thuật ngữ — Ngân hàng & Fintech |

### Phase 1 — tien va so cai

| Bài | Nội dung |
|---|---|
| [01](phase-1-tien-va-so-cai/01-tien-trong-he-thong.md) | Bài 1: Tiền trong hệ thống là gì? |
| [02](phase-1-tien-va-so-cai/02-hach-toan-kep.md) | Bài 2: Hạch toán kép — nguyên lý 500 năm không đổi |
| [03](phase-1-tien-va-so-cai/03-he-thong-tai-khoan.md) | Bài 3: Hệ thống tài khoản — thiết kế danh mục tài khoản cho fintech |
| [04](phase-1-tien-va-so-cai/04-so-du-kha-dung-va-phong-toa.md) | Bài 4: Số dư khả dụng, phong toả và giữ chỗ |
| [05](phase-1-tien-va-so-cai/05-vong-doi-giao-dich.md) | Bài 5: Vòng đời một giao dịch — từ khởi tạo tới đối soát |
| [06](phase-1-tien-va-so-cai/06-doi-soat.md) | Bài 6: Đối soát — vì sao luôn lệch và xử lý thế nào |
| [07](phase-1-tien-va-so-cai/07-tien-te-va-lam-tron.md) | Bài 7: Tiền tệ, làm tròn và những đồng lẻ biến mất |

### Phase 2 — thanh toan

| Bài | Nội dung |
|---|---|
| [01](phase-2-thanh-toan/01-ban-do-he-sinh-thai.md) | Bài 1: Bản đồ hệ sinh thái thanh toán — ai là ai |
| [02](phase-2-thanh-toan/02-chuyen-khoan-lien-ngan-hang.md) | Bài 2: Chuyển khoản liên ngân hàng — NAPAS, Citad và SWIFT |
| [03](phase-2-thanh-toan/03-thanh-toan-the.md) | Bài 3: Thanh toán thẻ — cấp phép, ghi nhận và quyết toán |
...
|---|---|
| Mới vào dự án fintech | đọc `00-gioi-thieu.md` rồi phase 1 tuần tự |
| Đang làm ví điện tử / cổng thanh toán | phase 1 bài 2, 4, 5 |
| Phụ trách đối soát | phase 1 bài 6 và 7 |
